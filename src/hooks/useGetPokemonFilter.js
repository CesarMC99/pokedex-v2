...
//   // const [ pokemonFilters, setPokemonFilters ] = useState([]) // data
...
//   const filtersURLS = pokemonList?.results.filter(pokemon => pokemon.name.includes(search))
//   const maxPages = Math.ceil(filtersURLS?.length / limit)
...
//   const preFetchingDataOfNextPage = () => {

//     if(currentPage === maxPages) return

//     filtersURLS?.slice((currentPage + 1)*limit-limit, (currentPage + 1)*limit)
//       .forEach(pokemon => {
...
//   return {
//     pokemonFilters,
//     isLoading : isLoadingPokemonList || isLoadingFilters,
//     isError : isErrorPokemonList || isErrorFilters,
//     currentPage,
//     previousPage,
//     nextPage
//   }
